...
const SubscribeSection = () => {
    ...
    return (
        <section className="w-auto h-screen relative flex flex-col md:flex-row bg-white-to-dark px-8 xl:px-12 py-24 xl:py-32">
            {/* Left Banner */}
            <div className="w-full md:w-1/2 xl:w-1/4 h-fit md:h-full flex md:items-end mr-0 md:mr-14">
                <div className="w-full h-full md:h-10/12 xl:h-full 2xl:h-10/12 flex flex-col justify-between items-start gap-4 md:gap-8 xl:gap-0">
                    <h1 className="font-vietnam font-semibold text-5xl md:text-5xl xl:text-6xl text-secondary">
                        Join Us.
                        <br/>
                        Come Along.
                        <br/>
                    ...
                    <p className="font-vietnam text-gray dark:text-white text-lg xl:text-xl">
                    ...
                    >
                        <input
                            ...
                            className="border-b-2 border-secondary py-2 text-lg font-anonymous placeholder:text-gray-400 dark:placeholder:text-gray-200 text-secondary"
                            placeholder="Email Adress"
                        />
                        <div className="w-full inline-flex gap-3">
                            <GradientButton type="subsribe" className="w-full font-semibold">Subscribe</GradientButton>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex-1 w-full flex flex-col justify-start gap-4 border border-red-500">
                                <h1 className="text-4xl font-vietnam font-semibold text-secondary">{b.title}</h1>
                                <div
