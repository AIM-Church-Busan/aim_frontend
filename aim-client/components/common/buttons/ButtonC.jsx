...
const baseClass =
    "button group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-white px-4 py-1 md:py-2 text-foreground active:scale-97 text-xs sm:text-sm md:text-base lg:text-sm xl:text-base";
