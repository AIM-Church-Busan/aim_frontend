...
const baseClass =
    "button group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-accent px-4 py-2 text-foreground active:scale-97 md:text-sm";
