    ...
    return (
        <div className="w-full h-auto grid grid-cols-2 grid-rows-2 xl:flex xl:flex-row xl:justify-start xl:items-center gap-2 sm:gap-4 xl:gap-2 mt-8 sm:mt-0">
            <Link
                ...
                className="flex items-center justify-center rounded-full bg-beige-to-black px-4 py-2 xl:hover:bg-secondary/80 transition-all duration-300 ease-in-out"
            >
                <Image
            ...
            <Link
                ...
                className="font-vietnam font-bold text-gray-400 flex flex-row items-center gap-1 justify-center rounded-full bg-beige-to-black px-5 py-2 xl:hover:bg-secondary/80 transition-all duration-300 ease-in-out"
            >
            ...
            <Link
                ...
                className="font-vietnam text-gray-400 flex items-center justify-center rounded-full bg-beige-to-black px-5 py-2 xl:hover:bg-secondary/80 transition-all duration-300 ease-in-out"
            >
                <div className="w-auto h-8 max-w-full inline-flex items-center justify-center">
                    <p>통일 비전 공동체</p>
                </div>
