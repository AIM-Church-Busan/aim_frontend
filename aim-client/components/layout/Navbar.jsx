      ...
      >
            ...
            <div className="flex flex-col items-center lg:flex-row">
              ...
              >
                ...
                <AnimatePresence>
                  ...
                  >
                    <div className="flex size-full max-w-full items-center justify-start bg-primary rounded-2xl px-8 mt-2 text-foreground">
                      <div className="flex w-full flex-col lg:flex-row">
                        <div className="grid flex-1 auto-cols-fr grid-cols-1 gap-x-8 gap-y-6 py-4 md:grid-cols-3 md:gap-y-0 md:py-8 lg:pr-8">
                          <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                            ...
                            >
                              <div className="flex size-10 flex-col items-center justify-center rounded-lg bg-background p-1">
                            ...
                            >
                              <div className="flex size-10 flex-col items-center justify-center rounded-lg bg-background p-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 28 28" fill="#000000">
                          ...
                          <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                            ...
                            >
                              <div className="flex size-10 flex-col items-center justify-center rounded-lg bg-background p-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 20 20" fill="#000000">
        ...
        <AnimatePresence>
          ...
          >
            ...
            >
              <div className="flex flex-col bg-primary p-8 rounded-2xl">
                <a
                    href="#"
                ...
                <div>
                  ...
                  <AnimatePresence>
                    <motion.nav
                        ...
                        exit="close"
                        transition={{ duration: 0.2 }}
                        className="bottom-auto left-0 top-full w-full min-w-full max-w-full overflow-hidden bg-primary lg:absolute lg:w-screen lg:border-b lg:border-border-primary lg:px-[5%] lg:[--height-close:auto] text-foreground"
                    >
                        ...
                        <div className="flex w-full flex-col lg:flex-row">
                          <div className="grid flex-1 auto-cols-fr grid-cols-1 gap-x-8 gap-y-6 py-4 md:grid-cols-3 md:gap-y-0 md:py-8 lg:pr-8">
                            <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                              ...
                              >
                                <div className="flex size-8 flex-col items-center justify-center rounded-lg bg-background p-1">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 24 24">
                                    <path className="fill-foreground/80 group-hover/1:fill-foreground transition-all duration-300 ease" d="M17.25 2A2.75 2.75 0 0 1 20 4.75v14.5A2.75 2.75 0 0 1 17.25 22H6.75A2.75 2.75 0 0 1 4 19.249V4.75A2.75 2.75 0 0 1 6.75 2h.291v8.167c0 .748.79 1.014 1.319.74l.09-.055l2.093-1.197l2.14 1.23c.446.308 1.261.1 1.35-.59l.008-.128V2h3.21Zm-4.709 0v7.076l-1.621-.932a.931.931 0 0 0-.793.022l-.107.063l-1.479.846V2h4Z"/>
                                  </svg>
                                </div>
                ...
                <div className="mt-6 flex flex-col gap-4">
                  <Button title="Button" variant="secondary" size="sm" className="bg-accent rounded-full py-4 font-anonymous font-bold">
                    SIGN UP
                  </Button>
                  <Button title="Button" size="sm" className="bg-white rounded-full py-4 font-anonymous font-bold">
                    LOG IN
                  </Button>
                </div>
              </div>
