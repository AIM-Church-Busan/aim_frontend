...
import ButtonE from '@/components/common/buttons/ButtonE';
...
const morphTransition = { duration: 0.35, ease: [0.4, 0, 0.2, 1] };
...
const Navbar = () => {
  ...
  return (
      <nav className={`
      fixed z-48 top-8 flex w-full items-center min-h-12
      px-4 lg:px-16 xl:px-36
      transition-all duration-300 ease-out
      ${visible ? "mt-5" : "mt-0"}
    `}>
        <motion.div className={`
        relative mx-auto flex size-full w-full xl:w-320 flex-col min-h-14 h-14
        px-2
        rounded-4xl overflow-hidden
        group/nav transition-colors duration-300 ease
        ${scrolled ? "bg-beige-to-black" : "bg-beige-to-black lg:bg-beige/40 lg:hover:bg-beige/80 lg:shadow-lg lg:shadow-black/5 lg:backdrop-blur-xl lg:backdrop-saturate-150"}`}
                    animate={{ height: isMoreOpen ? "auto" : 48 }}
                    transition={morphTransition}
                    onMouseLeave={() => setIsMoreOpen(false)}
        >
          <div className="flex flex-row min-h-12 w-full shrink-0 items-center justify-between">
            {/* Logo */}
            <a href="/" className="flex flex-row items-center gap-1 ml-2 h-14 my-auto">
              <img
                  src="/logo.png"
                  alt="AIM Church"
              ...
              <div className="flex flex-row items-baseline gap-1">
                <p className={scrolled ? "text-2xl text-foreground  transition-colors duration-300 ease" : "text-2xl text-foreground md:text-white transition-colors duration-300 ease group-hover/nav:text-foreground"}>AIM</p>
                <p className={`text-xs transition-colors duration-300 ease ${scrolled ? "text-foreground" : "text-foreground md:text-white group-hover/nav:text-foreground"}`}>수영로 교회</p>
              </div>
            </a>

            {/* Navigation (desktop) */}
            <div className={`
            hidden lg:flex flex-col items-center lg:flex-row
          `}>
              <FlipText href="/" className={`relative block w-auto py-3 text-md lg:inline-block lg:px-3  lg:text-sm hover:text-gray-400 transition-colors duration-300 ease   ${scrolled ? "text-foreground" : "text-white group-hover/nav:text-foreground"}`}>
                About Us
              </FlipText>
              <FlipText href="/" className={`relative block w-auto py-3 text-md lg:inline-block lg:px-3  lg:text-sm hover:text-gray-400 transition-colors duration-300 ease   ${scrolled ? "text-foreground" : "text-white group-hover/nav:text-foreground"}`}>
                Plan Your Visit
              ...
              <div>
                <button
                    className={`flex w-full items-center justify-between whitespace-nowrap py-3 text-md lg:w-auto hover:text-gray-400 lg:justify-start lg:gap-2 lg:px-4 lg:text-sm duration-300 ease
                  ${scrolled ? "text-foreground" : "text-white group-hover/nav:text-foreground"}`}
            ...
            <div className="hidden lg:flex items-center gap-3">
              <button className={`button relative inline-flex items-center justify-center overflow-hidden rounded-full px-4 py-2 md:text-sm hover:text-gray-400 transition-all duration-300 ease
              ${scrolled ? "text-foreground" : "text-white group-hover/nav:text-foreground"}`}>Log In</button>
              <ButtonE className={`group-hover/nav:text-foreground
              ${scrolled
                  ? "bg-white shadow-lg shadow-black/5 text-foreground"
                  : "bg-beige/10 shadow-lg shadow-black/5 backdrop-blur-xl backdrop-saturate-150 text-white"
              }
              `}>Sign Up</ButtonE>
            </div>
          ...
          <div id="desktop-more-menu" aria-label="More menu">
            <div className="flex size-full max-w-full items-center justify-start rounded-2xl px-8 mt-2 text-foreground">
                ...
                <div className="grid flex-1 auto-cols-fr grid-cols-1 gap-x-8 gap-y-6 py-4 md:grid-cols-3 md:gap-y-0 md:py-8 lg:pr-8">
                  <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                    ...
                    >
                      ...
                      <div className="flex flex-col items-start justify-center">
                        <FlipWaveText className="">New member class</FlipWaveText>
                    ...
                    >
                      ...
                      <div className="flex flex-col items-start justify-center">
                        <FlipWaveText className="">Join us</FlipWaveText>
                        <p className="hidden text-sm md:block">
                    ...
                    >
                      ...
                      <div className="flex flex-col items-start justify-center">
                        <FlipWaveText className="">Life groups</FlipWaveText>
                        <p className="hidden text-sm md:block">
                  ...
                  <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                    ...
                    >
                      ...
                      <div className="flex flex-col items-start justify-center">
                        <FlipWaveText className="">Announcements</FlipWaveText>
                        <p className="hidden text-sm md:block">
                    ...
                    >
                      ...
                      <div className="flex flex-col items-start justify-center">
                        <FlipWaveText className="">Events</FlipWaveText>
                        <p className="hidden text-sm md:block">
                    ...
                    >
                      ...
                      <div className="flex flex-col items-start justify-center">
                        <FlipWaveText className="">Contact</FlipWaveText>
                        <p className="hidden text-sm md:block">
                    ...
                    >
                      ...
                      <div className="flex flex-col items-start justify-center">
                        <FlipWaveText className="">Giving</FlipWaveText>
                        <p className="hidden text-sm md:block">
                          Support our mission
                        </p>
                      </div>
                  ...
                  <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                    ...
                    >
                      ...
                      <div className="flex flex-col items-start justify-center">
                        <FlipWaveText className="">Leadership</FlipWaveText>
                        <p className="hidden text-sm md:block">
                    ...
                    >
                      ...
                      <div className="flex flex-col items-start justify-center">
                        <FlipWaveText className="">FAQ</FlipWaveText>
                        <p className="hidden text-sm md:block">
        ...
        <AnimatePresence>
          ...
          >
            ...
            >
              <div className="flex flex-col p-8 rounded-2xl bg-beige-to-black">
                <a
                    href="#"
                    className="relative block w-auto py-3 text-md lg:inline-block lg:px-4 lg:py-6 lg:text-base font-semibold text-foreground"
                >
                  About Us
                </a>
                <a
                ...
                <div>
                  <button
                      className="relative flex w-full items-center justify-between whitespace-nowrap py-3 text-md lg:w-auto lg:justify-start lg:gap-2 lg:px-4 lg:py-6 lg:text-base font-semibold text-foreground"
                      onClick={() => setIsMobileAccordionOpen((v) => !v)}
                  ...
                  >
                    <span>More</span>
                    <motion.div
                        animate={isMobileAccordionOpen ? "rotated" : "initial"}
                        variants={{
                          rotated: { rotate: 180 },
                          initial: { rotate: 0 },
                        }}
                  ...
                  <AnimatePresence>
                    <motion.div
                        ...
                        animate={isMobileAccordionOpen ? "open" : "close"}
                        initial="close"
                        exit="close"
                        transition={{ duration: 0.2 }}
                        className="bottom-auto left-0 top-full w-full min-w-full max-w-full overflow-hidden lg:absolute lg:w-screen lg:border-b lg:border-border-primary lg:px-[5%] lg:[--height-close:auto] bg-beige-to-black text-foreground"
                ...
                <div className="mt-6 flex flex-col gap-4">
                  <Button title="Button" size="sm" className="bg-white rounded-full py-4 text-sm  border-none">
                    Log In
                  </Button>
                  <Button title="Button" variant="secondary" size="sm" className="bg-accent rounded-full py-4  text-sm border-none">
                    Sign Up
                  </Button>
