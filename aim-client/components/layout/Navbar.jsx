  ...
  return (
    ...
    >
      <div className="mx-auto flex size-full max-w-full items-center justify-between">
        ...
        <div className="absolute hidden h-screen overflow-auto border-b border-border-primary bg-background px-[5%] pb-24 pt-4 md:pb-0 lg:static lg:ml-6 lg:flex lg:h-auto lg:flex-1 lg:items-center lg:justify-between lg:border-none lg:bg-none lg:px-0 lg:pt-0">
                      ...
                      <div className="grid flex-1 auto-cols-fr grid-cols-1 gap-x-8 gap-y-6 py-4 md:grid-cols-3 md:gap-y-0 md:py-8 lg:pr-8">
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Plan visit</h5>
                              <p className="hidden text-sm md:block">
                                What to expect when you come Sunday
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Sermons</h5>
                              <p className="hidden text-sm md:block">
                                Listen to our latest teaching series
                              </p>
                            </div>
                          </a>
                          <a
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Announcements</h5>
                              <p className="hidden text-sm md:block">
                                Stay updated on church news and events
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Giving</h5>
                              <p className="hidden text-sm md:block">
                                Support the ministry with your generosity
                              </p>
                            </div>
                          </a>
                          <a
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Life groups</h5>
                              <p className="hidden text-sm md:block">
                                Connect in small groups throughout the week
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Programs for infants through youth
                              </p>
                            </div>
                          </a>
                        </div>
