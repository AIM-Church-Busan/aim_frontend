...
export function Navbar() {
  ...
  return (
      ...
      >
        <div className="mx-auto flex size-full max-w-full items-center justify-between rounded-2xl px-8 bg-background min-h-16 lg:min-h-auto">
          <a href="#" className="flex flex-row items-center gap-1">
            ...
            <div className="flex flex-row items-baseline gap-1">
              <p className="text-2xl text-foreground font-semibold">AIM</p>
              <p className="text-xs text-gray">수영로 교회</p>
            </div>
          </a>
          <div className="absolute hidden h-screen overflow-auto bg-background px-[5%] pb-24 pt-4 md:pb-0 lg:static lg:ml-6 lg:flex lg:h-auto lg:flex-1 lg:items-center lg:justify-between lg:border-none lg:bg-none lg:px-0 lg:pt-0 lg:overflow-visible">
              ...
              >
                ...
                <AnimatePresence>
                  <motion.nav
                      ...
                      className="bottom-auto left-0 top-full w-full min-w-full max-w-full overflow-hidden bg-transparent lg:absolute lg:w-screen px-12 lg:[--height-close:auto]"
                  >
                    <div className="flex size-full max-w-3/4 xl:max-w-2/3 items-center justify-start bg-background rounded-2xl px-8 mt-2">
